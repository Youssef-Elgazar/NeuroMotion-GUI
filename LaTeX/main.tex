...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.75\textwidth]{fig_system_architecture.jpeg}
\caption{High-level system architecture of NeuroMotion.}
...
\begin{figure}[p]
\centering
\includegraphics[width=\textwidth, height=0.9\textheight, keepaspectratio]{DFD-L1}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=\textwidth, height=0.85\textheight, keepaspectratio]{State-diagram}
