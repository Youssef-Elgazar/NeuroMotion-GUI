...
The core problem addressed by NeuroMotion is the exclusion of individuals with motor
disabilities from controlling assistive robotic devices. Current solutions create systematic
accessibility barriers:

\begin{itemize}
    \item Physical controllers (joysticks, keyboards) require intact motor function.
    \item Voice control is unreliable for users with speech impairments.
    \item Eye-tracking is limited in scope and induces fatigue over prolonged use.
    \item Existing consumer EEG products lack the accuracy, safety mechanisms, and
          real-time pipeline integration required for robust robotic control.
\end{itemize}

The consequences include reduced independence, mental health deterioration, increased
caregiver burden, and the broader societal underutilisation of human potential.
...
% ─────────────────────────────────────────────────────────────
%  CHAPTER 2 — EEG Background & Neuroscience
% ─────────────────────────────────────────────────────────────
\chapter{EEG Background \& Neuroscience}
...
functional organisation of the brain, the cellular origin of EEG signals, the
...
\begin{figure}[h]
\centering
\includegraphics[width=0.75\textwidth]{fig_brain_lobes}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{fig_neuron}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.65\textwidth]{fig_1020}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{fig_erd_ers}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.75\textwidth]{fig_epoc_x}
...
\begin{figure}[htbp]
\centering
%% PLACEHOLDER: replace with fig_system_architecture.png when available
\fbox{\parbox{0.85\textwidth}{\centering\vspace{2cm}
\textit{[System Architecture Diagram]}\\
File: \texttt{fig\_system\_architecture.png}\\
Shows: Flask (5000) + FastAPI (8000) + SQLite + Fernet + PySerial
\vspace{2cm}}}
...
\begin{figure}[htbp]
\centering
%% PLACEHOLDER: replace with fig_ml_pipeline.png when available
\fbox{\parbox{0.85\textwidth}{\centering\vspace{2cm}
\textit{[ML Pipeline Flowchart]}\\
File: \texttt{fig\_ml\_pipeline.png}\\
Flow: Raw EEG $\rightarrow$ Bandpass $\rightarrow$ CSP $\rightarrow$ Dual SVM
$\rightarrow$ Confidence Gate $\rightarrow$ Robot Command
\vspace{2cm}}}
...
\begin{figure}[htbp]
\centering
%% PLACEHOLDER: replace with fig_security_flow.png when available
\fbox{\parbox{0.85\textwidth}{\centering\vspace{2cm}
\textit{[Security Flow Diagram]}\\
File: \texttt{fig\_security\_flow.png}\\
Flow: Session data $\rightarrow$ JSON $\rightarrow$ Fernet encrypt $\rightarrow$ .enc file
\vspace{2cm}}}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.90\textwidth]{fig_gui_login}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.90\textwidth]{fig_gui_dashboard}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.90\textwidth]{fig_gui_eyetracking}
